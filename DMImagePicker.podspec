Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/DimaAvvakumov/DMPopupAlert.git", :tag => "0.1.0" }
  s.source_files = "DMImagePicker", "DMImagePicker/*.{h,m}", "DMImagePicker/core/*.{h,m}"
  s.public_header_files = "DMImagePicker/*.{h,m}"
  s.framework    = "UIKit"
  s.requires_arc = true
  s.resources    = 'DMImagePicker/DMImagePicker.xib', 'DMImagePicker/core/DMImageEditViewController.xib', 'DMImagePicker/DMImagePicker.bundle'
